...
export const SobreMiPage: React.FC = () => {
  ...
  // Part 1 (First 6 paragraphs: Law & Home, Argentine emigration to Spain, Lucas Fox)
  const part1Paragraphs = ABOUT_ME_SOURCE.paragraphs.slice(0, 6);
  // Part 2 (Remaining paragraphs: Technical accreditation, Golden Coast, Cunit anecdote, vision)
  const part2Paragraphs = ABOUT_ME_SOURCE.paragraphs.slice(6);
  ...
  return (
    <div className="pt-24 sm:pt-28 bg-[#FBF9F3] min-h-screen text-[#24211D]">
      ...
      <main className="max-w-6xl mx-auto px-6 sm:px-10 py-14 sm:py-20">
        ...
        {/* =====================================================================
            BLOQUE 1: FOTO MÁS ANCHA Y PROPORCIONADA A LA IZQUIERDA
            SUBTÍTULO ARRIBA DEL TEXTO (A LA DERECHA) + PÁRRAFOS PARTE 1
           ===================================================================== */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
          
          {/* Columna Izquierda: Retrato amplio, natural y proporcionado (sin marco excesivamente alto) */}
        ...
        {/* =====================================================================
            BLOQUE 2: INSIGNIAS EDITORIALES BOUTIQUE CON MATICES CLAROS Y FINOS ACENTOS DORADOS
            API / Perito judicial / Especialista LAU
           ===================================================================== */}
        ...
        {/* =====================================================================
            BLOQUE 3: SIGUIENTE CUADRO DE TEXTO
            Subtítulo + Párrafos restantes + Anécdota de Cunit + Conclusión
           ===================================================================== */}
        <section className="space-y-6">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-[#24211D] leading-tight pb-2">
            Una relación que continúa después de cada operación
          </h2>
          ...
          <div className="mt-14 p-8 sm:p-10 bg-[#F5F2EA] border border-[#E8E2D5] text-center space-y-4 max-w-xl mx-auto">
            <h3 className="text-2xl font-serif text-[#24211D]">
              Conversemos sobre tu proyecto inmobiliario
            </h3>
            <p className="text-sm text-[#4A463F] font-sans">
              Estoy a tu disposición para escucharte y resolver cualquier consulta con la máxima discreción y rigor.
            </p>
            <div className="pt-3">
              <button
              ...
              >
                <span>Solicitar una cita online</span>
